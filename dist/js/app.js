...
var app = new Vue({
  ...
  methods: {
    chekGenere: function chekGenere(index) {
      if (this.genere === 'All') {
        return true;
    ...
    oderByYearUp: function oderByYearUp(selected) {
  ...
  mounted: function mounted() {
    ...
    axios.get('/api/dischi.php').then(function (resp) {
      ...
      for (var index = 0; index < _this.albums.length; index++) {
        var element = _this.albums[index];
